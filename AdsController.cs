...
public class AdsController : MonoBehaviour
{
    ...
    void MakeSingleton()
    {
        ...
        else
        {
            ...
            //SetID 
            android_BannerAds = GameInfo.Android.GoogleAds_BannerAds;
      ...
      {
    #if UNITY_EDITOR
          string adUnitId = "ca-app-pub-7796374447657441/6778146674";
#elif UNITY_ANDROID
          string adUnitId = "ca-app-pub-7796374447657441/6778146674";
#elif UNITY_IPHONE
            string adUnitId = "ca-app-pub-7796374447657441/6778146674";
...
#if UNITY_ANDROID
        string adUnitId = "ca-app-pub-7796374447657441/9979025081";
#elif UNITY_IPHONE
